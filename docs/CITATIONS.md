...
2. **One phone number everywhere.** `+91 95423 44555`. Not a second mobile, not a landline "for enquiries".
...
Search Google for `"Brolly Juniors" "95423 44555"` and check the top 30 results. Any listing with an old address, a different phone number or a misspelled name is actively working against you. Correct it or get it removed.
